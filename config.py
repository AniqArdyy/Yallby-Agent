...
# ── Kredit developer (watermark di pesan bot) ─────────────────────────────
DEVELOPER_NAME = "AniqArdyy"
SHOW_DEVELOPER_CREDIT = True  # True = footer kredit ikut di setiap pesan bot

# ── Telegram ──────────────────────────────────────────────────────────────
TELEGRAM_BOT_TOKEN = os.environ["TELEGRAM_BOT_TOKEN"]  # wajib diisi lewat environment variable
...
ADMIN_CHAT_ID = os.environ.get("ADMIN_CHAT_ID", os.environ.get("TELEGRAM_CHAT_ID", "")) or None
